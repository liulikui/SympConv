...
TEST(RayTest, ParameterizedConstructor) {
    Ray ray(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(1.0), Real(0.0), Real(0.0)), Real(1.0));
    EXPECT_TRUE(SympConv::RealEqual(ray.mOrigin.x, Real(0.0)));
    EXPECT_TRUE(SympConv::RealEqual(ray.mDirection.x, Real(1.0)));
    EXPECT_TRUE(SympConv::RealEqual(ray.mMax, Real(1.0)));
}
...
TEST(RayTest, TransformWithScaling) {
    Ray ray(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(1.0), Real(1.0), Real(1.0)), Real(1.0));
    // 创建一个缩放2倍的变换
...
TEST(RayTest, Normalize) {
    Ray ray(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(2.0), Real(0.0), Real(0.0)), Real(1.0));
    ray.Normalize();
    EXPECT_TRUE(SympConv::RealEqual(ray.mDirection.x, Real(1.0)));
...
TEST(RayTest, Normalized) {
    Ray ray(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(0.0), Real(3.0), Real(0.0)), Real(1.0));
...
TEST(RayTest, CopyConstructor) {
    Ray original(Vec3(Real(1.0), Real(2.0), Real(3.0)), Vec3(Real(4.0), Real(5.0), Real(6.0)), Real(1.0));
    Ray copy(original);
    ...
    EXPECT_TRUE(SympConv::RealEqual(copy.mMax, Real(1.0)));
}
...
TEST(RayTest, MoveConstructor) {
    ...
    EXPECT_TRUE(SympConv::RealEqual(moved.mMax, Real(1.0)));
}
...
TEST(RayTest, AssignmentOperator) {
    ...
    EXPECT_TRUE(SympConv::RealEqual(assigned.mMax, Real(1.0)));
}
...
TEST(RayTest, Normalize_ZeroVector) {
    // 测试归一化零向量的情况
    Ray ray(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(0.0), Real(0.0), Real(0.0)), Real(1.0));
    ray.Normalize();
    // 零向量归一化后应该还是零向量
...
TEST(RayTest, ChainedOperations) {
    // 测试链式操作
    Ray ray(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(2.0), Real(2.0), Real(2.0)), Real(1.0));
...
TEST(RayTest, DistanceTo_WithTMinTMax) {
    // 测试射线段到点的距离，考虑mMax
    Ray ray(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(1.0), Real(0.0), Real(0.0)), Real(3.0));
    ...
    // 应该返回点到射线的垂直距离
    EXPECT_TRUE(SympConv::RealEqual(distance2, Real(1.0)));
...
TEST(RayTest, DistanceToRay_WithTMinTMax) {
    ...
    // 这两条射线段在(1,0,0)处相交
    Ray ray1(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(1.0), Real(0.0), Real(0.0)), Real(2.0));
    Ray ray2(Vec3(Real(1.0), Real(-1.0), Real(0.0)), Vec3(Real(0.0), Real(1.0), Real(0.0)), Real(2.0));
    ...
    // 测试不相交的射线段
    Ray ray3(Vec3(Real(0.0), Real(0.0), Real(0.0)), Vec3(Real(1.0), Real(0.0), Real(0.0)), Real(1.0));
    Ray ray4(Vec3(Real(2.0), Real(1.0), Real(0.0)), Vec3(Real(0.0), Real(1.0), Real(0.0)), Real(1.0));
